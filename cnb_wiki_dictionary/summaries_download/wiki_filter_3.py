...
from cnb_dictionary_creator.download.caches import (
    WikiRedirectsCategoriesCache,
    WikiSummariesCache,
)
from cnb_dictionary_creator.wiki_utils.redirects_categories_parser import (
    parse_redirects_categories,
)
from cnb_dictionary_creator.wiki_utils.variants_extractor import (
    extract_variants,
)
from cnb_dictionary_creator.wiki_utils.labels_extractor import (
    extract_labels,
)
from config import WIKI_FILTER_2_OUTPUT, WIKI_FILTER_3_OUTPUT
...
def main():
    with open(WIKI_FILTER_2_OUTPUT) as file:
    ...
    with open(WIKI_FILTER_3_OUTPUT, "w+") as file:
        lines = [
